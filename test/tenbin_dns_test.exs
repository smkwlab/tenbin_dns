defmodule TenbinDnsTest do
  ...
  describe "Stats on create" do
    ...
    test "create_question_item", fixture do
      ...
      assert DNSpacket.create_question_item(question) == fixture.domain_name_result <> <<1::16,1::16>>
    end
    ...
    test "create_answer_item", fixture do
      ...
      answer_ns = %{name: fixture.domain_name, type: :ns, class: :in, ttl: 21599, rdata: %{name: "a.iana-servers.net."}}
      assert DNSpacket.create_rr(answer_ns) == fixture.domain_name_result <> <<2::16,1::16,0,0,0x54,0x5f,0,0x14,0x01,0x61,0x0c,0x69,0x61,0x6e,0x61,0x2d,0x73,0x65,0x72,0x76,0x65,0x72,0x73,0x03,0x6e,0x65,0x74,0x00>>
    end
