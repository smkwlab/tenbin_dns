defmodule SimpleQuestionOptimized do
  @moduledoc """
  Simple Question-focused benchmark with speed optimizations applied
  """

  def run_benchmarks do
    # Same test packets as baseline for accurate comparison
    test_packets = %{
    ...
    IO.puts("Question-Focused OPTIMIZED Performance")
    IO.puts("=====================================")
    IO.puts("Focus: Small packets with 1 Question record")
    IO.puts("With speed optimizations applied")
    IO.puts("")
    ...
    IO.puts("Running optimized measurements...")
    IO.puts("")
    ...
    # Display results
    IO.puts("Question Parse Performance (OPTIMIZED):")
    IO.puts("======================================")
    ...
    IO.puts("")
    IO.puts("Component Performance (OPTIMIZED):")
    IO.puts("==================================")
    ...
    IO.puts("")
    IO.puts("OPTIMIZED Code Characteristics:")
    IO.puts("- Aggressive function inlining")
    IO.puts("- Native compilation with HiPE O3")
    IO.puts("- parse_question_fast with 2-tuple returns")
    IO.puts("- Optimized parse_name with iolist accumulator")
    IO.puts("- Pre-cached DNS type/class lookups")
    IO.puts("- byte_size instead of String.length")
    IO.puts("- :erlang.iolist_to_binary for concat_binary_list")
  end
...
SimpleQuestionOptimized.run_benchmarks()